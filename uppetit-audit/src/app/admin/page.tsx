    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto pb-20 relative">
      ...
      <div className="flex gap-6 mb-6 border-b border-gray-200 overflow-x-auto">
        ...
        <button
          ...
          className={`pb-3 font-black text-sm whitespace-nowrap transition-colors border-b-2 ${activeTab === 'isolated' ? 'border-[#F25C05] text-gray-900' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
        >
              ...
              <div className="space-y-3">
                {data.topLocations.map((loc, i) => (
                  <div key={i} className="flex justify-between items-center p-3.5 bg-green-50/50 border border-green-100/50 rounded-2xl hover:bg-green-50 transition-colors">
                    ...
                    <span className="font-black text-green-600 bg-white px-3 py-1.5 rounded-lg border border-green-100 shadow-sm shrink-0 flex items-center gap-1">
              ...
              <div className="space-y-3">
                {data.bottomLocations.map((loc, i) => (
                  <div key={i} className="flex justify-between items-center p-3.5 bg-red-50/50 border border-red-100/50 rounded-2xl hover:bg-red-50 transition-colors">
                    ...
                    <span className="font-black text-red-500 bg-white px-3 py-1.5 rounded-lg border border-red-100 shadow-sm shrink-0 flex items-center gap-1">
                      {loc.avg} б. <span className="text-[11px] opacity-70">({loc.avgPct}%)</span>
                    </span>
                  </div>
                ))}
