...
// ИСПРАВЛЕНО: Прямой и надежный импорт типов через глобальный алиас @/
  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden transition-all">
      <div 
        ...
        className="p-5 cursor-pointer active:bg-gray-50 flex justify-between items-center"
      >
        <div>
                  ...
                  <div key={audit.id} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-3">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="text-xs text-gray-500 mt-1">Аудитор: <span className="font-bold">{audit.user?.login || audit.auditorName || 'Неизвестно'}</span></div>
                      </div>
