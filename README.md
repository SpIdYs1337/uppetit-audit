...
* 📸 **Работа с медиа (AWS S3)**: Прямая загрузка фотографий нарушений в облачное хранилище (S3) с автоматической очисткой файлов старше 12 месяцев по Cron-расписанию.
